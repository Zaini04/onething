...
function OfficeExpenses() {
  ...
  const [filters, setFilters] = useState({ expenseType: "", from: "", to: "" });
  ...
  const handleEdit = (row) => {
    ...
    navigate("/app/office-expense#edit");
  };
 ...
 const handleFilterChange = (name, value) => {
  ...
  const handleSearchSubmit = (finalFilters) => {
    ...
    setApiFilters({
      expenseType: finalFilters.expenseType,
        ...
        >
          {addExpenseModelOpen && (
            <div className="w-full ">
              <AddOfficeExpense editExpense={editExpense} setEditedExpense={setEditedExpense} />
            </div>
          )}
        </div>
      </div>
