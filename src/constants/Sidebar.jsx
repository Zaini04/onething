export const menuItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        ...
        />
        <path
          d="M4 21V9C4 6.17157 4 4.75736 4.87868 3.87868C5.75736 3 7.17157 3 10 3C12.8284 3 14.2426 3 15.1213 3.87868C16 4.75736 16 6.17157 16 9V21H4Z"
          stroke="currentColor"
          strokeWidth="1.3"
        />
        <path
  ...
  // Add this at the end of your menuItems array in constants/Sidebar.js
  {
    id: "reports",
    label: "Reports",
    isHeader: true, // Marker to make it non-clickable
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path
          d="M22 10V15C22 19 20 22 16 22H8C4 22 2 19 2 15V9C2 5 4 2 8 2H13"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    subItems: [
      { id: "employee-bills", label: "Employees Bills", link: "/app/reports/employee-bills" },
      { id: "labour-bills", label: "Labour Bills", link: "/app/reports/labour-bills" },
      { id: "company-bills", label: "Company Bills", link: "/app/reports/company-bills" },
    ],
  },
];
