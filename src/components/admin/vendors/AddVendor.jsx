...
const AddVendor = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      email: '',
      address: '',
      city: '', // Dropdown styling consistent rakhne ke liye empty string rakha ha
      state: '',
      status: '',
    },
    ...
    <div className="w-full mx-auto p-4 md:p-6 bg-[#F9FAFB] rounded-2xl">
      ...
      <form onSubmit={formik.handleSubmit} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-7">
          <InputField label="Name" id="name" placeholder="Vendor Name" formik={formik} />
