...
function ExportModel({ isOpen, onClose, onConfirm }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-6 sm:p-8 gap-y-4 w-full max-w-[320px] flex flex-col  items-center text-center z-10 animate-in fade-in zoom-in-95 duration-200">
